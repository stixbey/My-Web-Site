...
Hello i am stix welcome to my website!

                </p>
              </div>
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="umutbayraktar" src={`https://cdn.discordapp.com/attachments/974404943383511080/1010762500591063090/20220818_225138_0000-1.png`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
        ...
        <div className="py-20">
        <p className="text-3xl text-white font-semibold">Hi!</p>
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://discord.gg/GRkYArtwrk`+_.name}
                      target="_blank"
                      rel="noreferrer"
