      ...
      <div className="py-20">
        ...
        <div className=" flex justify-center flex-col items-center">
            <div className="max-w-lg w-full">
                <a target="_blank" rel="norefferer" href=" https://instagram.com/stix_dev/">
                    <div className="flex justify-between bg-zinc-500/5 hover:bg-zinc-500/10 transition-all duration-200 px-4 py-2 rounded-lg items-center">
                        ...
                        <p className="font-semibold text-xl">@stix_dev</p>
                    </div>
                </a>
                <a target="_blank" rel="norefferer" href="https://facebook.com/stix_dev/">
                    <div className="mt-2 flex justify-between bg-zinc-500/5 hover:bg-zinc-500/10 transition-all duration-200 px-4 py-2 rounded-lg items-center">
                        <i className="fab fa-facebook fa-2x" />
                        <p className="font-semibold text-xl">@stix_dev</p>
                    </div>
                </a>
                <a target="_blank" rel="norefferer" href="https://discord.gg/GRkYArtwrk">
                    <div className="mt-2 flex justify-between bg-zinc-500/5 hover:bg-zinc-500/10 transition-all duration-200 px-4 py-2 rounded-lg items-center">
                        <i className="fab fa-discord fa-2x" />
                        <p className="font-semibold text-xl">Stix Inc.#0806</p>
                    </div>
                </a>
                <a href="mailto:umutbayraktar55@gmail.com">
                    <div className="mt-2 flex justify-between bg-zinc-500/5 hover:bg-zinc-500/10 transition-all duration-200 px-4 py-2 rounded-lg items-center">
                        <i className="fa fa-envelope fa-2x" />
                        <p className="font-semibold text-xl">gbot@outlook.com.tr</p>
                    </div>
                </a>
            </div>
        </div>
